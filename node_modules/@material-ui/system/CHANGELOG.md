...
- [StartDatePicker] Fix codesandbox demo (#19926) @netochaves
...
- 📊 Launch a [developer survey](https://www.surveymonkey.com/r/5XHDL76) as a precursor to a major StartDatePicker enhancement effort.
...
- [docs] Prepare the StartDatePicker developer survey notification (#17805) @oliviertassinari
...
- [StartDatePicker] Auto switch the view when a year is selected (#5700)
...
- [StartDatePicker] Improve the RTL support (#5155)
- [StartDatePicker] Improve the i18n support (#5187)
...
- [StartDatePicker] Improve dark theme support (#4943)
- [StartDatePicker] Changes opacity of disabled day-buttons (#4994)
...
- [StartDatePicker] Expose dialog container style (#4355)
- [StartDatePicker] Fix year overflow (#4381)
...
- [StartDatePicker] `className` prop is now set on the root element instead of being passed down (#4250)
...
- [StartDatePicker] Added className prop to StartDatePicker (#4250)
- [StartDatePicker] Fix layout when used with border-box (#4454)
- [StartDatePicker] Fix the issue about onDismiss function will fire by handleTouchTapOk (#4367)
- [StartDatePicker] Fix `weekTitleDayStyle` (#4464)
...
- [Picker] Disable userSelect on TimePicker and StartDatePicker (#4176)
...
- [StartDatePicker] Add support for built-in en-US locale (#4161)
...
- [StartDatePicker] ok/cancel labels in date pickers should be of PropTypes.node (#3869)
...
- [StartDatePicker] Add a check to fetch current system date (#3656)
- [StartDatePicker] Fix cursor pointer of the header (#3598)
- [StartDatePicker] Fix selectYear range (#3496)
- [StartDatePicker] Use popover for the inline mode (#3532)
...
##### Deprecations
- [StartDatePicker] Deprecate `wordings` with `cancelLabel` and `okLabel` (#3412)
...
- [StartDatePicker] Standardize for ISO8601. (#3417)
...
- [Docs] StartDatePicker - Add disabled dates example (#3167)
...
- [StartDatePicker] Default to ISO-8601 DateTimeFormat & `firstDayOfWeek` (#3417)
...
- [StartDatePicker] Added `disabled` property (#3060)
...
- [StartDatePicker] Add `firstDayOfWeek` and days abbreviations (#2899)
...
#### Component Fixes / Enhancements
- [StartDatePicker] Update slide direction (#2791)
...
- [StartDatePicker] Fix year selection (#2410)
...
- [StartDatePicker] fix calendarTextColor context key (#2318)
...
- [StartDatePicker] add container prop to display StartDatePicker in-line or inside Dialog (#2120 and #2153)
...
- [StartDatePicker] fix calendar height (#2141)
...
- [StartDatePicker] i18n support added (#1658)
...
#### Component Fixes / Enhancements
- StartDatePicker performance has been improved (#1905)
...
#### Component Fixes / Enhancements
- StartDatePicker - Updated to new design specs (#1266)
...
- StartDatePicker - Fixed an error that occurred when using valueLink (#1400)
...
- Changed `date-picker/index.js` to expose StartDatePicker and DatePickerDialog.
...
- StartDatePicker
  - Allow using StartDatePicker as a controlled input (#1170)
...
- StartDatePicker
  ...
  - Fixed StartDatePicker year/month navigation buttons (#1081, #1075)
- Dialog
...
- StartDatePicker will now properly handle defaultDate prop changes (#722)
